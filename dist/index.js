...
const previousLine = document.getElementById('ans');
let pendingOperation;
// Digits
const digit0Btn = document.getElementById('digit0');
const digit1Btn = document.getElementById('digit1');
const digit2Btn = document.getElementById('digit2');
const digit3Btn = document.getElementById('digit3');
const digit4Btn = document.getElementById('digit4');
const digit5Btn = document.getElementById('digit5');
const digit6Btn = document.getElementById('digit6');
const digit7Btn = document.getElementById('digit7');
const digit8Btn = document.getElementById('digit8');
const digit9Btn = document.getElementById('digit9');
...
const multiplicationBtn = document.getElementById('times');
const divisionBtn = document.getElementById('divide');
const equalBtn = document.getElementById('equals');
const squareBtn = document.getElementById('square');
const squareRootBtn = document.getElementById('root');
// events
additionBtn.onclick = () => {
...
// Others
const displayCachedOpe = document.getElementById('currentOperation');
...
(function (mathOperation) {
    ...
    mathOperation["square"] = "^2";
    mathOperation["squareRoot"] = "square";
